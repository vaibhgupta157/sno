...
class yc_device_sno__devices_device(PybindBase):
  ...
  def __init__(self, *args, **kwargs):
    ...
    self.__device_type = YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'CumulusLinux': {}},), is_leaf=True, yang_name="device_type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='enumeration', is_config=True)
    ...
    self.__serial_number = YANGDynClass(base=six.text_type, is_leaf=True, yang_name="serial_number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='string', is_config=True)
    self.__total_interfaces = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="total_interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='uint32', is_config=True)
  ...
  def _set_device_type(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'CumulusLinux': {}},), is_leaf=True, yang_name="device_type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='enumeration', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """device_type must be of a type compatible with enumeration""",
          'defined-type': "sno:enumeration",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=six.text_type,                                     restriction_type="dict_key",                                     restriction_arg={'CumulusLinux': {}},), is_leaf=True, yang_name="device_type", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='enumeration', is_config=True)""",
        })
  ...
  def _set_serial_number(self, v, load=False):
    ...
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=six.text_type, is_leaf=True, yang_name="serial_number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='string', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """serial_number must be of a type compatible with string""",
          'defined-type': "string",
          'generated-type': """YANGDynClass(base=six.text_type, is_leaf=True, yang_name="serial_number", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='string', is_config=True)""",
        })
  ...
  def _get_total_interfaces(self):
    """
    Getter method for total_interfaces, mapped from YANG variable /devices/device/total_interfaces (uint32)
    """
    return self.__total_interfaces
      
  def _set_total_interfaces(self, v, load=False):
    """
    Setter method for total_interfaces, mapped from YANG variable /devices/device/total_interfaces (uint32)
    If this variable is read-only (config: false) in the
    source YANG file, then _set_total_interfaces is considered as a private
    method. Backends looking to populate this variable should
    do so via calling thisObj._set_total_interfaces() directly.
    """
    if hasattr(v, "_utype"):
      v = v._utype(v)
    try:
      t = YANGDynClass(v,base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="total_interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='uint32', is_config=True)
    except (TypeError, ValueError):
      raise ValueError({
          'error-string': """total_interfaces must be of a type compatible with uint32""",
          'defined-type': "uint32",
          'generated-type': """YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="total_interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='uint32', is_config=True)""",
        })

    self.__total_interfaces = t
    if hasattr(self, '_set'):
      self._set()

  def _unset_total_interfaces(self):
    self.__total_interfaces = YANGDynClass(base=RestrictedClassType(base_type=long, restriction_dict={'range': ['0..4294967295']}, int_size=32), is_leaf=True, yang_name="total_interfaces", parent=self, path_helper=self._path_helper, extmethods=self._extmethods, register_paths=True, namespace='http://example.com/sno', defining_module='sno', yang_type='uint32', is_config=True)
  ...
  total_interfaces = __builtin__.property(_get_total_interfaces, _set_total_interfaces)
  config = __builtin__.property(_get_config, _set_config)


  _pyangbind_elements = OrderedDict([('name', name), ('device_type', device_type), ('mgmt_ip', mgmt_ip), ('netconf_port', netconf_port), ('netconf_user', netconf_user), ('netconf_password', netconf_password), ('serial_number', serial_number), ('total_interfaces', total_interfaces), ('config', config), ])
